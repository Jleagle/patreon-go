...
type Data struct {
	Attributes struct {
		...
		PledgeCapAmountCents         unmarshal.Int `json:"pledge_cap_amount_cents"`
...
type User struct {
	Attributes struct {
		About              unmarshal.String `json:"about"`
		CanSeeNsfw         bool             `json:"can_see_nsfw"`
		Created            time.Time        `json:"created"`
		DefaultCountryCode interface{}      `json:"default_country_code"`
		DiscordID          string           `json:"discord_id"`
		Email              string           `json:"email"`
		Facebook           unmarshal.String `json:"facebook"`
		FacebookID         unmarshal.Int64  `json:"facebook_id"`
		...
		SocialConnections  struct {
			Deviantart unmarshal.String `json:"deviantart"`
			Discord    struct {
				Scopes []string         `json:"scopes"`
				URL    unmarshal.String `json:"url"`
			...
			Spotify unmarshal.String `json:"spotify"`
			Twitch  unmarshal.String `json:"twitch"`
			Twitter struct {
				URL    string `json:"url"`
				UserID string `json:"user_id"`
			} `json:"twitter"`
			Youtube unmarshal.String `json:"youtube"`
		} `json:"social_connections"`
		ThumbURL    string           `json:"thumb_url"`
		Twitch      unmarshal.String `json:"twitch"`
		Twitter     unmarshal.String `json:"twitter"`
		URL         string           `json:"url"`
		Vanity      unmarshal.String `json:"vanity"`
		Youtube     unmarshal.String `json:"youtube"`
...
type Campaign struct {
	Attributes struct {
		...
		MainVideoEmbed                unmarshal.String `json:"main_video_embed"`
		MainVideoURL                  unmarshal.String `json:"main_video_url"`
		Name                          string           `json:"name"`
		OneLiner                      unmarshal.String `json:"one_liner"`
		...
		ThanksEmbed                   unmarshal.String `json:"thanks_embed"`
		ThanksMsg                     unmarshal.String `json:"thanks_msg"`
		ThanksVideoURL                unmarshal.String `json:"thanks_video_url"`
		URL                           string           `json:"url"`
...
type Tier struct {
	Attributes struct {
		...
		ImageURL         unmarshal.String `json:"image_url"`
		PatronCount      int              `json:"patron_count"`
